...
class MultiTileStore(TileStore):
    def __init__(self, layers, default_layer_name=None, **kwargs):
        TileStore.__init__(self, **kwargs)
        self.layers = layers
        self.default_layer = self.layers.get(default_layer_name)

    def _get_store(self, layer):
        return self.layers.get(layer, self.default_layer)
