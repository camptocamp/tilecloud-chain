...
class MultiTileStore(TileStore):
    ...
    def _get_layer(self, tile):
        return self.layers.get(tile.metadata.get('layer', None), self.default_layer)
    ...
    def __contains__(self, tile):
        ...
        """
        return tile in self._get_layer(tile)
    ...
    def delete_one(self, tile):
        ...
        """
        return self._get_layer(tile).delete_one(tile)
    ...
    def put_one(self, tile):
        ...
        """
        return self._get_layer(tile).put_one(tile)
    ...
    def get_one(self, tile):
        ...
        """
        return self._get_layer(tile).get_one(tile)
