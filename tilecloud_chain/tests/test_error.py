...
class TestError(CompareCase):
    ...
    def test_resolution(self, l):
        self.run_cmd(
            './buildout/bin/generate_controller -c tilecloud_chain/tests/wrong_resolutions.yaml',
            controller.main)
        l.check(
    ...
    def test_mapnik_grid_meta(self, l):
        self.run_cmd(
            './buildout/bin/generate_controller -c tilecloud_chain/tests/wrong_mapnik_grid_meta.yaml',
            controller.main)
        l.check(
    ...
    def test_exists(self, l):
        self.run_cmd(
            './buildout/bin/generate_controller -c tilecloud_chain/tests/wrong_exists.yaml',
            controller.main)
        l.check(
    ...
    def test_type(self, l):
        self.run_cmd(
            './buildout/bin/generate_controller -v -c tilecloud_chain/tests/wrong_type.yaml',
            controller.main)
        l.check(
