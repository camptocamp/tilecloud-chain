...
class TestMultihost(CompareCase):
    ...
    def test_code(self):
        ...
        if os.path.exists('/tmp/tests/test/tests/hooks/post-restore-code'):
        ...
        f = open('/tmp/tests/test/tests/hooks/post-restore-database', 'r')
