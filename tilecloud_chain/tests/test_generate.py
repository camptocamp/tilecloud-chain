...
class TestGenerate(CompareCase):
    ...
    def test_hash(self):
        self.assert_cmd_equals(
            './buildout/bin/generate_tiles --get-hash 4/0/0 -c tilecloud_chain/tests/test.yaml',
            generate.main,
            """Tile: 4/0/0:+8/+8
...
Tile: 4/0/0
    ...
    def test_hash_mapnik(self):
        self.assert_cmd_equals(
            './buildout/bin/generate_tiles --get-hash 4/0/0 -c tilecloud_chain/tests/test.yaml -l mapnik',
            generate.main,
            """Tile: 4/0/0:+8/+8
    empty_metatile_detection:
        size: 16375
...
Tile: 4/0/0
    ...
    def test_hash_mapnik_grid(self):
        self.assert_cmd_equals(
            './buildout/bin/generate_tiles --get-hash 4/0/0 -c tilecloud_chain/tests/test.yaml -l all',
            generate.main,
            """Tile: 4/0/0
    empty_tile_detection:
        size: 334
    ...
    def test_test_all(self):
        self.assert_tiles_generated(
            './buildout/bin/generate_tiles -c tilecloud_chain/tests/test.yaml -t 1',
            generate.main,
            "/tmp/tiles/",
    ...
    def test_zoom(self):
        self.assert_tiles_generated(
            './buildout/bin/generate_tiles -c tilecloud_chain/tests/test.yaml -l point --zoom 1',
            generate.main,
            "/tmp/tiles/",
            '1.0.0/%s/default/2012/swissgrid_5/%i/%i/%i.png', [
    ...
    def test_bbox(self):
        self.assert_tiles_generated(
            './buildout/bin/generate_tiles -c tilecloud_chain/tests/test.yaml -l polygon -z 0',
            generate.main,
            "/tmp/tiles/",
        ...
        self.assert_tiles_generated(
            './buildout/bin/generate_tiles -c tilecloud_chain/tests/test.yaml -l all -z 0',
            generate.main,
            "/tmp/tiles/",
    ...
    def test_hash_generation(self):
        self.assert_tiles_generated(
            './buildout/bin/generate_tiles -c tilecloud_chain/tests/test.yaml -l point_hash -z 0',
            generate.main,
            "/tmp/tiles/",
    ...
    def test_mapnik(self):
        self.assert_tiles_generated(
            './buildout/bin/generate_tiles -c tilecloud_chain/tests/test.yaml -l mapnik -z 0',
            generate.main,
            "/tmp/tiles/",
    ...
    def test_mapnik_grid(self):
        self.assert_tiles_generated(
            './buildout/bin/generate_tiles -c tilecloud_chain/tests/test.yaml -l mapnik_grid -z 0',
            generate.main,
            "/tmp/tiles/",
    ...
    def test_not_authorised_user(self):
        self.assert_cmd_exit_equals(
            './buildout/bin/generate_tiles -c tilecloud_chain/tests/test-authorised.yaml',
            generate.main,
            """not authorised, authorised user is: www-data.""")

    def test_time(self):
        self.assert_cmd_equals(
            './buildout/bin/generate_tiles -c tilecloud_chain/tests/test.yaml --time 2 -l polygon',
            generate.main,
            """size: 776
size: 860
size: 860
